...
# END USER LICENSE AGREEMENT (“License” or “EULA”)
...
### 2. SUBSCRIPTION, PAYMENTS, & RENEWALS
...
* **Subscription Terms:** You may select from monthly, yearly or lifetime (of the Software as described below) subscription terms. Monthly and yearly subscriptions automatically renew for the same subscription term as originally selected unless terminated by the user.
...
### 3. USER-MANAGED DATA AND STORAGE, BACKUP, AND IMPORTS
...
### 9. LEGAL COMPLIANCE AND EXPORT CONTROL
...
### 13. SEVERABILITY AND ENTIRE LICENSE
...
### 18. TECHNICAL SUPPORT, QUESTIONS OR COMMENTS
